package com.xixiha.hook.ui.activity
...
import com.xixiha.hook.BuildConfig.*
import com.xixiha.hook.R
import com.xixiha.hook.databinding.ActivityMainBinding
import com.xixiha.hook.service.SkipService
import com.xixiha.hook.ui.adapter.ViewPagerAdapter
import com.xixiha.hook.ui.fragment.MainFragment
import com.xixiha.hook.utils.*
import com.xixiha.hook.utils.Data.QQ_GROUP
import com.xixiha.hook.utils.Data.buildTime
import com.xixiha.hook.utils.Data.checkRoot
import com.xixiha.hook.utils.Data.global
import com.xixiha.hook.utils.Data.hideOrShowLauncherIcon
import com.xixiha.hook.utils.Data.hookTip
import com.xixiha.hook.utils.Data.isAccessibilitySettingsOn
import com.xixiha.hook.utils.Data.isLauncherIconShowing
import com.xixiha.hook.utils.Data.localeId
import com.xixiha.hook.utils.Data.runService
import com.xixiha.hook.utils.Data.setSpan
import com.xixiha.hook.utils.Data.stopService
import com.xixiha.hook.utils.Data.themes
import com.xixiha.hook.utils.Data.updateConfig
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initView() {
        ...
        val system = Fragment.instantiate(
            applicationContext,
            MainFragment::class.java.name,
            systemBundle
        ) as MainFragment
    ...
    private fun checkUpdate(show: Boolean) {
        if (show) {
            Toast.makeText(applicationContext, R.string.check_update_failed, Toast.LENGTH_SHORT)
                .show()
        }
    }
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menu.findItem(R.id.menu_language_settings).subMenu?.setHeaderTitle(
            getString(R.string.language_settings).setSpan(
                getColor(R.color.theme)
            )
        )
        menu.findItem(R.id.menu_theme_settings).subMenu?.setHeaderTitle(
            getString(R.string.menu_theme_settings).setSpan(
                getColor(R.color.theme)
            )
        )
        menu.findItem(R.id.menu_module_settings).subMenu?.setHeaderTitle(
            getString(R.string.menu_module_settings).setSpan(
                getColor(R.color.theme)
            )
        )
        this.menu = menu
        ...
        return when (item.itemId) {
            ...
            R.id.menu_qq_group -> {
                ...
                try {
                    ...
                    Toast.makeText(
                        applicationContext,
                        getString(R.string.failed_to_open_qq),
                        Toast.LENGTH_SHORT
                    ).show()
                }
                true
            ...
            R.id.menu_github -> {
                try {
                    val intent = Intent(
                        Intent.ACTION_VIEW,
                        Uri.parse("https://github.com/hujiayucc/Fuck-AD")
                    )
                    startActivity(intent)
                } catch (e: Exception) {
                    e.printStackTrace()
